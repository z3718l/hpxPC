...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/css/slide.css\" rel=\"stylesheet\" type=\"text/css\" />\r\n    <script src=\"");
	templateBuilder.Append("/templates/main");
	...
	templateBuilder.Append("script>\r\n    <script src=\"");
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/js/bootstrap.min.js\" type=\"text/javascript\"></");
	templateBuilder.Append("script>\r\n    <script src=\"");
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/js/slide.js\" type=\"text/javascript\"></");
	templateBuilder.Append("script>\r\n    <script src=\"");
	templateBuilder.Append("/templates/main");
	...
	string category_nav = get_category_menu("list", category_id);

	templateBuilder.Append("\r\n                    <div class=\"list-home\">您当前的位置：<a href=\"");
	templateBuilder.Append(linkurl("index"));

	templateBuilder.Append("\">首页</a>");
	templateBuilder.Append(Utils.ObjectToStr(category_nav));
	templateBuilder.Append("</div>\r\n                    <ul>\r\n                        ");
	DataTable articleList = get_article_list(channel.name, category_id, pagesize, page, "status=0", out totalcount, out pagelist, "list", category_id, "__id__");

	int article__loop__id=0;
	...
	templateBuilder.Append(linkurl("show",Utils.ObjectToStr(article["id"])));

	templateBuilder.Append("\">");
	templateBuilder.Append(Utils.DropHTML(Utils.ObjectToStr(article["title"]),70));

	templateBuilder.Append("</a>\r\n                            <span>");	templateBuilder.Append(Utils.ObjectToDateTime(Utils.ObjectToStr(article["add_time"])).ToString(" yyyy-MM-dd"));
