...
<div class="nlist-2">
  ...
  <ul>
    ...
    <li>升级通知：<asp:Literal ID="LitUpgrade" Visible="false" runat="server"/></li>
  </ul>
</div>
<div class="line20"></div>

<div class="nlist-4" style="visibility: hidden;">
  ...
  <ul>
    <asp:Literal ID="LitNotice" Visible="false" runat="server"/>
  </ul>
</div>
-->
<!--/内容-->
